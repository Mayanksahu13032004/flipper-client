...
<div id='card' className=' w-[22%] ml-12 mt-10 mb-10 bg-white hover:shadow-xl  hover:border-4 hover:border-gray-600 hover:border-solid pb-4 '>
  ...
  <img src={card.card_image} alt="" />
    <div className='flex '>
      <div id='home' className=' bg-slate-400 p-2 pt-1 pb-1 text-md mt-4 ml-4'>home</div>
      <div id='family' className='bg-slate-400 p-2 pt-1 pb-1 text-md mt-4 ml-4'>{card.tag}</div>
    </div>
